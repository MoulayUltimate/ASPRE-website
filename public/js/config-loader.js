...
(function () {
    ...
    function updateStripe(stripe) {
        ...
        // Logic: If geo-currency is active, it might override this. 
        // We should update the global config that geo-currency uses if possible, 
        // or update the DOM directly if geo-currency isn't loaded yet.
        ...
        buyButtons.forEach(btn => {
            ...
            // Ideally, we rely on the checkout modal to handle the link
            if (stripe.links.usd) {
